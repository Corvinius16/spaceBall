...
class ModelLoader  extends GameObject{
    constructor(Scene,Name){
        ...
        let thisObj = this;
        loader2.load("https://corvinius16.github.io/spaceBall/models/Platform.glb",function(obj){
        ...
        loader2.load("https://corvinius16.github.io/spaceBall/models/Ball.glb",function(obj){
        ...
        loader2.load("https://corvinius16.github.io/spaceBall/models/Barrier.glb",function(obj){
            let object=obj.scene.children[0].children[0];//new THREE.InstancedMesh(obj.children[0].geometry,new THREE.MeshBasicMaterial(),100);
            object.scale.set(1,1,1);
           object.geometry.computeBoundingBox();
            thisObj.setModel("barr",object);
        });
        loader2.load("https://corvinius16.github.io/spaceBall/models/Aim.glb",function(obj){
            let object=obj.scene.children[0].children[0];//new THREE.InstancedMesh(obj.children[0].geometry,new THREE.MeshBasicMaterial(),100);
            object.scale.set(1,1,1);
            object.geometry.computeBoundingBox();
            object.name="Score";
